...
$desc = array(
   ...
   if($lang=="Java")
    $cmd = "exec schroot -c bionic --directory ".$wd." -- java $code";
   else if($lang=="Python")
    $cmd = "exec schroot -c bionic --directory ".$wd." -- python3 main.py";
   else if($lang=="C" || $lang=="C++")
     $cmd= "exec schroot -c bionic --directory ".$wd." -- stdbuf -o0 ./a.out";
