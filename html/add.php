...
<body>
				...
				<form method="POST" action="../include/open_code.php">
					...
					<div class="dropdown code-options ">
						...
						<i class="fas fa-ellipsis-v"></i>
							...
							<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
								<button class="dropdown-item r-btn" >Rename</button>
	...
	<form action="../include/open_code.php" method="POST" >
		<i class="far fa-window-close re"></i>
		<label class="cb-heading">Rename code</label>
		<input class="rname" type="text" name="codename" placeholder="Rename your code" name="rename">
